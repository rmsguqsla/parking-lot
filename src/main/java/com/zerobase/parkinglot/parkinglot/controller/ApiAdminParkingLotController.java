...
public class ApiAdminParkingLotController {
    ...
    // 주차장 수정(삭제) API
    @ApiOperation(value = "주차장 수정 및 삭제 API")
    @PreAuthorize("hasRole('ADMIN')")
    ...
    // 이용권 수정(식제) API
    @ApiOperation(value = "이용권 수정 및 삭제 API")
    @PreAuthorize("hasRole('ADMIN')")
